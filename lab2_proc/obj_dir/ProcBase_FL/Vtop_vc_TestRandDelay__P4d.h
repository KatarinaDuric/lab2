...
#ifndef VERILATED_VTOP_VC_TESTRANDDELAY__P4D_H_
#define VERILATED_VTOP_VC_TESTRANDDELAY__P4D_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_TestRandDelay__P4d final : public VerilatedModule {
  public:
    // CELLS
    ...
    VL_INW(__PVT__in_msg,76,0,3);
    VL_OUTW(__PVT__out_msg,76,0,3);
    IData/*31:0*/ __PVT__rand_num;
    IData/*31:0*/ __PVT__rand_delay_next;
    IData/*31:0*/ __PVT__rand_delay;
    IData/*31:0*/ __Vtogcov__max_delay;
    VlWide<3>/*76:0*/ __Vtogcov__in_msg;
    VlWide<3>/*76:0*/ __Vtogcov__out_msg;
    ...
    // CONSTRUCTORS
    Vtop_vc_TestRandDelay__P4d(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_TestRandDelay__P4d();
    VL_UNCOPYABLE(Vtop_vc_TestRandDelay__P4d);
