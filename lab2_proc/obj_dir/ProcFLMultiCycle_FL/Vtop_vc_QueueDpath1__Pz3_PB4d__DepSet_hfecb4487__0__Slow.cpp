...
VL_ATTR_COLD void Vtop_vc_QueueDpath1__Pz3_PB4d___stl_comb__TOP__top__mem__mem__memreq0_queue__genblk1__DOT__dpath__0(Vtop_vc_QueueDpath1__Pz3_PB4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueDpath1__Pz3_PB4d___stl_comb__TOP__top__mem__mem__memreq0_queue__genblk1__DOT__dpath__0\n"); );
    // Body
...
VL_ATTR_COLD void Vtop_vc_QueueDpath1__Pz3_PB4d___stl_comb__TOP__top__mem__mem__memreq0_queue__genblk1__DOT__dpath__1(Vtop_vc_QueueDpath1__Pz3_PB4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueDpath1__Pz3_PB4d___stl_comb__TOP__top__mem__mem__memreq0_queue__genblk1__DOT__dpath__1\n"); );
    // Body
...
VL_ATTR_COLD void Vtop_vc_QueueDpath1__Pz3_PB4d___stl_comb__TOP__top__mem__mem__memreq1_queue__genblk1__DOT__dpath__0(Vtop_vc_QueueDpath1__Pz3_PB4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueDpath1__Pz3_PB4d___stl_comb__TOP__top__mem__mem__memreq1_queue__genblk1__DOT__dpath__0\n"); );
    // Body
    if ((1U & (VL_BITSEL_IWII(77, vlSelf->__PVT__enq_msg, 0U) 
               ^ VL_BITSEL_IWII(77, vlSelf->__Vtogcov__enq_msg, 0U)))) {
        vlSymsp->__Vcoverage[6257].fetch_add(1, std::memory_order_relaxed);
