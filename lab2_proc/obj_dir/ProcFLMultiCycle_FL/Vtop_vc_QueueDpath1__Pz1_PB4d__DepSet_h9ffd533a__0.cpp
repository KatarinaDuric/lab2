...
VL_INLINE_OPT void Vtop_vc_QueueDpath1__Pz1_PB4d___act_comb__TOP__top__DUT__dmem_queue__genblk1__DOT__dpath__0(Vtop_vc_QueueDpath1__Pz1_PB4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueDpath1__Pz1_PB4d___act_comb__TOP__top__DUT__dmem_queue__genblk1__DOT__dpath__0\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_vc_QueueDpath1__Pz1_PB4d___act_comb__TOP__top__DUT__dmem_queue__genblk1__DOT__dpath__1(Vtop_vc_QueueDpath1__Pz1_PB4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueDpath1__Pz1_PB4d___act_comb__TOP__top__DUT__dmem_queue__genblk1__DOT__dpath__1\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_vc_QueueDpath1__Pz1_PB4d___act_comb__TOP__top__DUT__dmem_queue__genblk1__DOT__dpath__2(Vtop_vc_QueueDpath1__Pz1_PB4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueDpath1__Pz1_PB4d___act_comb__TOP__top__DUT__dmem_queue__genblk1__DOT__dpath__2\n"); );
    // Body
