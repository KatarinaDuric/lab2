...
#ifndef VERILATED_VTOP_VC_TESTSOURCEFILE__P20_PBA_H_
#define VERILATED_VTOP_VC_TESTSOURCEFILE__P20_PBA_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_TestSourceFile__P20_PBa final : public VerilatedModule {
  public:
    // CELLS
    ...
    VlUnpacked<IData/*31:0*/, 10> __PVT__m_load;

    // INTERNAL VARIABLES
    Vtop__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtop_vc_TestSourceFile__P20_PBa(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_TestSourceFile__P20_PBa();
    VL_UNCOPYABLE(Vtop_vc_TestSourceFile__P20_PBa);
