...
VL_ATTR_COLD void Vtop_vc_Queue__Pz1_PB20_PC1___ctor_var_reset(Vtop_vc_Queue__Pz1_PB20_PC1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_Queue__Pz1_PB20_PC1___ctor_var_reset\n"); );
    // Body
    vlSelf->__PVT__clk = VL_RAND_RESET_I(1);
    vlSelf->__PVT__reset = VL_RAND_RESET_I(1);
    vlSelf->__PVT__enq_val = VL_RAND_RESET_I(1);
    vlSelf->__PVT__enq_rdy = VL_RAND_RESET_I(1);
    vlSelf->__PVT__enq_msg = VL_RAND_RESET_I(32);
    vlSelf->__PVT__deq_val = VL_RAND_RESET_I(1);
    vlSelf->__PVT__deq_rdy = VL_RAND_RESET_I(1);
    vlSelf->__PVT__deq_msg = VL_RAND_RESET_I(32);
    vlSelf->__PVT__num_free_entries = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtogcov__enq_msg = VL_RAND_RESET_I(32);
    vlSelf->__Vtogcov__deq_val = VL_RAND_RESET_I(1);
    vlSelf->__Vtogcov__deq_rdy = VL_RAND_RESET_I(1);
    vlSelf->__Vtogcov__deq_msg = VL_RAND_RESET_I(32);
    vlSelf->__Vtogcov__num_free_entries = VL_RAND_RESET_I(1);
