...
#ifndef VERILATED_VTOP_LAB2_PROC_PROCALT_H_
#define VERILATED_VTOP_LAB2_PROC_PROCALT_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vtop_lab2_proc_DropUnit__P2f;
class Vtop_lab2_proc_ProcAltCtrl;
class Vtop_lab2_proc_ProcAltDpath;
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_lab2_proc_ProcAlt final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vtop_lab2_proc_ProcAltCtrl* __PVT__ctrl;
    Vtop_lab2_proc_ProcAltDpath* __PVT__dpath;
    ...
    struct {
        ...
        CData/*1:0*/ __PVT__op1_byp_sel_D;
        CData/*1:0*/ __PVT__op2_byp_sel_D;
    ...
    // CONSTRUCTORS
    Vtop_lab2_proc_ProcAlt(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_lab2_proc_ProcAlt();
    VL_UNCOPYABLE(Vtop_lab2_proc_ProcAlt);
