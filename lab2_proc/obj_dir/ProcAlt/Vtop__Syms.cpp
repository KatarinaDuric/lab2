...
Vtop__Syms::Vtop__Syms(VerilatedContext* contextp, const char* namep, Vtop* modelp)
    ...
    , TOP__top__DUT__dpath__op1_byp_sel_mux_D{this, Verilated::catName(namep, "top.DUT.dpath.op1_byp_sel_mux_D")}
    ...
    , TOP__top__DUT__dpath__op2_byp_sel_mux_D{this, Verilated::catName(namep, "top.DUT.dpath.op2_byp_sel_mux_D")}
    ...
    , TOP__top__src__src__index_reg{this, Verilated::catName(namep, "top.src.src.index_reg")}
{
    ...
    TOP__top__DUT__dpath.__PVT__op1_byp_sel_mux_D = &TOP__top__DUT__dpath__op1_byp_sel_mux_D;
    ...
    TOP__top__DUT__dpath.__PVT__op2_byp_sel_mux_D = &TOP__top__DUT__dpath__op2_byp_sel_mux_D;
    ...
    TOP__top__DUT__dpath__op1_byp_sel_mux_D.__Vconfigure(true);
    TOP__top__DUT__dpath__op1_reg_X.__Vconfigure(false);
    TOP__top__DUT__dpath__op1_sel_mux_D.__Vconfigure(true);
    TOP__top__DUT__dpath__op2_byp_sel_mux_D.__Vconfigure(false);
    ...
    TOP__top__DUT__dpath__pc_sel_mux_F.__Vconfigure(false);
