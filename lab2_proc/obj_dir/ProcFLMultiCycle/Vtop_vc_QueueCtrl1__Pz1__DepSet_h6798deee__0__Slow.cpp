...
VL_ATTR_COLD void Vtop_vc_QueueCtrl1__Pz1___ctor_var_reset(Vtop_vc_QueueCtrl1__Pz1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueCtrl1__Pz1___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__Vdly__full = VL_RAND_RESET_I(1);
}
