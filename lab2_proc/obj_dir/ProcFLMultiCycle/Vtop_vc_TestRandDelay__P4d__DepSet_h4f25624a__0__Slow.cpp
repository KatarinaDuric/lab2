...
VL_ATTR_COLD void Vtop_vc_TestRandDelay__P4d___ctor_var_reset(Vtop_vc_TestRandDelay__P4d* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_TestRandDelay__P4d___ctor_var_reset\n"); );
    // Body
    ...
    VL_RAND_RESET_W(77, vlSelf->__PVT__in_msg);
    vlSelf->__PVT__out_val = VL_RAND_RESET_I(1);
    vlSelf->__PVT__out_rdy = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(77, vlSelf->__PVT__out_msg);
    ...
    VL_RAND_RESET_W(77, vlSelf->__Vtogcov__in_msg);
    vlSelf->__Vtogcov__out_val = VL_RAND_RESET_I(1);
    vlSelf->__Vtogcov__out_rdy = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(77, vlSelf->__Vtogcov__out_msg);
