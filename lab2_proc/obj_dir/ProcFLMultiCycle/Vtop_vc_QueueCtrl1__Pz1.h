...
#ifndef VERILATED_VTOP_VC_QUEUECTRL1__PZ1_H_
#define VERILATED_VTOP_VC_QUEUECTRL1__PZ1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_QueueCtrl1__Pz1 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_vc_QueueCtrl1__Pz1(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_QueueCtrl1__Pz1();
    VL_UNCOPYABLE(Vtop_vc_QueueCtrl1__Pz1);
