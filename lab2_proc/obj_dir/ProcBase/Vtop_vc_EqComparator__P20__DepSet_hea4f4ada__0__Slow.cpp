...
VL_ATTR_COLD void Vtop_vc_EqComparator__P20___ctor_var_reset(Vtop_vc_EqComparator__P20* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_EqComparator__P20___ctor_var_reset\n"); );
    // Body
