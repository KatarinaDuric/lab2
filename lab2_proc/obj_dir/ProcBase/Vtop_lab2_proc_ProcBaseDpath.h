...
#ifndef VERILATED_VTOP_LAB2_PROC_PROCBASEDPATH_H_
#define VERILATED_VTOP_LAB2_PROC_PROCBASEDPATH_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_lab2_proc_ProcBaseDpath final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtop_lab2_proc_ProcBaseDpath(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_lab2_proc_ProcBaseDpath();
    VL_UNCOPYABLE(Vtop_lab2_proc_ProcBaseDpath);
