...
VL_ATTR_COLD void Vtop_vc_TestSinkFile__P20_PBa___ctor_var_reset(Vtop_vc_TestSinkFile__P20_PBa* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_TestSinkFile__P20_PBa___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__t = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtogcov__failed = VL_RAND_RESET_I(1);
    vlSelf->__Vtogcov__verbose = VL_RAND_RESET_I(4);
    vlSelf->__Vtogcov__m_curr = VL_RAND_RESET_I(32);
