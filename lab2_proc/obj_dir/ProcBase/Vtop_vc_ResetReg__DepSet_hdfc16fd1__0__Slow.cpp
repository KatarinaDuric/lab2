...
VL_ATTR_COLD void Vtop_vc_ResetReg___configure_coverage(Vtop_vc_ResetReg* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[10230]), first, "../vc/regs.v", 42, 30, "", "v_toggle/vc_ResetReg", "clk", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[10231]), first, "../vc/regs.v", 43, 30, "", "v_toggle/vc_ResetReg", "reset", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[10232]), first, "../vc/regs.v", 44, 30, "", "v_toggle/vc_ResetReg", "q[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[10233]), first, "../vc/regs.v", 45, 30, "", "v_toggle/vc_ResetReg", "d[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[10234]), first, "../vc/regs.v", 48, 3, "", "v_line/vc_ResetReg", "block", "48-49");
}
