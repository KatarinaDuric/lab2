...
VL_INLINE_OPT void Vtop_vc_TestMem_2ports4B__P4000___nba_comb__TOP__top__mem__mem__12(Vtop_vc_TestMem_2ports4B__P4000* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_TestMem_2ports4B__P4000___nba_comb__TOP__top__mem__mem__12\n"); );
    // Body
