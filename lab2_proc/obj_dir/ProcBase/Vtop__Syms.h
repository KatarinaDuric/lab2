...
class alignas(VL_CACHE_LINE_BYTES)Vtop__Syms final : public VerilatedSyms {
  public:
    ...
    Vtop_top                       TOP__top;
    Vtop_lab2_proc_ProcBase        TOP__top__DUT;
    Vtop_lab2_proc_ProcBaseCtrl    TOP__top__DUT__ctrl;
    ...
    Vtop_lab2_proc_ProcBaseDpath   TOP__top__DUT__dpath;
    ...
    // COVERAGE
    std::atomic<uint32_t> __Vcoverage[11596];
