...
VL_ATTR_COLD void Vtop_vc_MemReqMsg4BTrace___stl_sequent__TOP__top__DUT__imem_reqstream_trace__2(Vtop_vc_MemReqMsg4BTrace* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_MemReqMsg4BTrace___stl_sequent__TOP__top__DUT__imem_reqstream_trace__2\n"); );
    // Body
...
VL_ATTR_COLD void Vtop_vc_MemReqMsg4BTrace___stl_sequent__TOP__top__DUT__dmem_reqstream_trace__2(Vtop_vc_MemReqMsg4BTrace* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_MemReqMsg4BTrace___stl_sequent__TOP__top__DUT__dmem_reqstream_trace__2\n"); );
    // Body
    if (((IData)(vlSelf->__PVT__clk) ^ (IData)(vlSelf->__Vtogcov__clk))) {
        vlSymsp->__Vcoverage[6171].fetch_add(1, std::memory_order_relaxed);
        vlSelf->__Vtogcov__clk = vlSelf->__PVT__clk;
