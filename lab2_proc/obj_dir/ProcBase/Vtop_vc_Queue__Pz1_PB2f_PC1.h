...
#ifndef VERILATED_VTOP_VC_QUEUE__PZ1_PB2F_PC1_H_
#define VERILATED_VTOP_VC_QUEUE__PZ1_PB2F_PC1_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vtop_vc_QueueCtrl1__Pz1;
class Vtop_vc_QueueDpath1__Pz1_PB2f;


class Vtop__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_Queue__Pz1_PB2f_PC1 final : public VerilatedModule {
  public:
    // CELLS
    Vtop_vc_QueueCtrl1__Pz1* __PVT__genblk1__DOT__ctrl;
    Vtop_vc_QueueDpath1__Pz1_PB2f* __PVT__genblk1__DOT__dpath;
    ...
    // CONSTRUCTORS
    Vtop_vc_Queue__Pz1_PB2f_PC1(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_Queue__Pz1_PB2f_PC1();
    VL_UNCOPYABLE(Vtop_vc_Queue__Pz1_PB2f_PC1);
