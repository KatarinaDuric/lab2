...
#ifndef VERILATED_VTOP_VC_QUEUEDPATH1__PZ1_PB4D_H_
#define VERILATED_VTOP_VC_QUEUEDPATH1__PZ1_PB4D_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_QueueDpath1__Pz1_PB4d final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtop_vc_QueueDpath1__Pz1_PB4d(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_QueueDpath1__Pz1_PB4d();
    VL_UNCOPYABLE(Vtop_vc_QueueDpath1__Pz1_PB4d);
