...
VL_ATTR_COLD void Vtop_vc_TestRandDelay__P20___stl_comb__TOP__top__src__msg_delay__1(Vtop_vc_TestRandDelay__P20* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_TestRandDelay__P20___stl_comb__TOP__top__src__msg_delay__1\n"); );
    // Body
