...
VL_ATTR_COLD void Vtop_vc_MemReqMsgUnpack__pi4___ctor_var_reset(Vtop_vc_MemReqMsgUnpack__pi4* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_MemReqMsgUnpack__pi4___ctor_var_reset\n"); );
    // Body
    ...
    VL_RAND_RESET_W(77, vlSelf->__PVT__req);
    ...
    VL_RAND_RESET_W(77, vlSelf->__Vtogcov__req);
}
