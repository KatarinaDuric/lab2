...
VL_ATTR_COLD void Vtop_vc_EnResetReg__P4_PBz2___configure_coverage(Vtop_vc_EnResetReg__P4_PBz2* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5125]), first, "../vc/regs.v", 95, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "clk", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5126]), first, "../vc/regs.v", 96, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "reset", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5127]), first, "../vc/regs.v", 97, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "q[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5128]), first, "../vc/regs.v", 97, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "q[1]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5129]), first, "../vc/regs.v", 97, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "q[2]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5130]), first, "../vc/regs.v", 97, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "q[3]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5131]), first, "../vc/regs.v", 98, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "d[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5132]), first, "../vc/regs.v", 98, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "d[1]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5133]), first, "../vc/regs.v", 98, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "d[2]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5134]), first, "../vc/regs.v", 98, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "d[3]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5135]), first, "../vc/regs.v", 99, 30, "", "v_toggle/vc_EnResetReg__P4_PBz2", "en", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5136]), first, "../vc/regs.v", 103, 5, "", "v_branch/vc_EnResetReg__P4_PBz2", "if", "103-104");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5137]), first, "../vc/regs.v", 103, 6, "", "v_branch/vc_EnResetReg__P4_PBz2", "else", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5138]), first, "../vc/regs.v", 102, 3, "", "v_line/vc_EnResetReg__P4_PBz2", "block", "102");
}
