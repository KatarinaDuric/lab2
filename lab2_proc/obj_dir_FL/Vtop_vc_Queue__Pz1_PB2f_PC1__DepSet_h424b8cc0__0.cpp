...
VL_INLINE_OPT void Vtop_vc_Queue__Pz1_PB2f_PC1___act_comb__TOP__top__mem__mem__memresp0_queue__1(Vtop_vc_Queue__Pz1_PB2f_PC1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_Queue__Pz1_PB2f_PC1___act_comb__TOP__top__mem__mem__memresp0_queue__1\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_vc_Queue__Pz1_PB2f_PC1___act_comb__TOP__top__mem__mem__memresp1_queue__1(Vtop_vc_Queue__Pz1_PB2f_PC1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_Queue__Pz1_PB2f_PC1___act_comb__TOP__top__mem__mem__memresp1_queue__1\n"); );
    // Body
    vlSelf->__PVT__genblk1__DOT__write_en = vlSelf->__PVT__genblk1__DOT__ctrl->__PVT__write_en;
    vlSelf->__PVT__genblk1__DOT__dpath->__PVT__write_en 
        = vlSelf->__PVT__genblk1__DOT__write_en;
