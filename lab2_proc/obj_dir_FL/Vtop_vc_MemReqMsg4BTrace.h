...
#ifndef VERILATED_VTOP_VC_MEMREQMSG4BTRACE_H_
#define VERILATED_VTOP_VC_MEMREQMSG4BTRACE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_MemReqMsg4BTrace final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtop_vc_MemReqMsg4BTrace(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_MemReqMsg4BTrace();
    VL_UNCOPYABLE(Vtop_vc_MemReqMsg4BTrace);
