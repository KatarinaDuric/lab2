...
VL_INLINE_OPT void Vtop_lab2_proc_ProcFLMultiCycle___act_sequent__TOP__top__DUT__3(Vtop_lab2_proc_ProcFLMultiCycle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_lab2_proc_ProcFLMultiCycle___act_sequent__TOP__top__DUT__3\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_lab2_proc_ProcFLMultiCycle___act_sequent__TOP__top__DUT__4(Vtop_lab2_proc_ProcFLMultiCycle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_lab2_proc_ProcFLMultiCycle___act_sequent__TOP__top__DUT__4\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_lab2_proc_ProcFLMultiCycle___act_comb__TOP__top__DUT__4(Vtop_lab2_proc_ProcFLMultiCycle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_lab2_proc_ProcFLMultiCycle___act_comb__TOP__top__DUT__4\n"); );
    // Body
