...
VL_ATTR_COLD void Vtop_vc_TestMem_2ports4B__P4000___stl_sequent__TOP__top__mem__mem__3(Vtop_vc_TestMem_2ports4B__P4000* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_TestMem_2ports4B__P4000___stl_sequent__TOP__top__mem__mem__3\n"); );
    // Init
    ...
    vlSelf->__PVT__m_next[0x4dbU] = vlSelf->__PVT__m
        [0x4dbU];
    vlSelf->__PVT__m_next[0x4daU] = vlSelf->__PVT__m
        [0x4daU];
    vlSelf->__PVT__m_next[0x4d9U] = vlSelf->__PVT__m
        [0x4d9U];
    vlSelf->__PVT__m_next[0x4d8U] = vlSelf->__PVT__m
        [0x4d8U];
    vlSelf->__PVT__m_next[0x4d7U] = vlSelf->__PVT__m
        [0x4d7U];
    vlSelf->__PVT__m_next[0x4d6U] = vlSelf->__PVT__m
        [0x4d6U];
