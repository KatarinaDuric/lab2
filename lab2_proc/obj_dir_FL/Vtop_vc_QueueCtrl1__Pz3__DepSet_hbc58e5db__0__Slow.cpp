...
VL_ATTR_COLD void Vtop_vc_QueueCtrl1__Pz3___stl_comb__TOP__top__mem__mem__memreq0_queue__genblk1__DOT__ctrl__0(Vtop_vc_QueueCtrl1__Pz3* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueCtrl1__Pz3___stl_comb__TOP__top__mem__mem__memreq0_queue__genblk1__DOT__ctrl__0\n"); );
    // Body
...
VL_ATTR_COLD void Vtop_vc_QueueCtrl1__Pz3___stl_comb__TOP__top__mem__mem__memreq1_queue__genblk1__DOT__ctrl__0(Vtop_vc_QueueCtrl1__Pz3* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_vc_QueueCtrl1__Pz3___stl_comb__TOP__top__mem__mem__memreq1_queue__genblk1__DOT__ctrl__0\n"); );
    // Body
    if (((IData)(vlSelf->__PVT__enq_val) ^ (IData)(vlSelf->__Vtogcov__enq_val))) {
        vlSymsp->__Vcoverage[6226].fetch_add(1, std::memory_order_relaxed);
        vlSelf->__Vtogcov__enq_val = vlSelf->__PVT__enq_val;
...
VL_ATTR_COLD void Vtop_vc_QueueCtrl1__Pz3___configure_coverage(Vtop_vc_QueueCtrl1__Pz3* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6224]), first, "../vc/queues.v", 38, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "clk", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6225]), first, "../vc/queues.v", 39, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "reset", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6226]), first, "../vc/queues.v", 41, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "enq_val", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6227]), first, "../vc/queues.v", 42, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "enq_rdy", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6228]), first, "../vc/queues.v", 44, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "deq_val", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6229]), first, "../vc/queues.v", 45, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "deq_rdy", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6230]), first, "../vc/queues.v", 47, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "write_en", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6231]), first, "../vc/queues.v", 48, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "bypass_mux_sel", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6232]), first, "../vc/queues.v", 49, 16, "", "v_toggle/vc_QueueCtrl1__Pz3", "num_free_entries", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6233]), first, "../vc/queues.v", 54, 9, "", "v_toggle/vc_QueueCtrl1__Pz3", "full", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6234]), first, "../vc/queues.v", 55, 9, "", "v_toggle/vc_QueueCtrl1__Pz3", "full_next", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6235]), first, "../vc/queues.v", 57, 3, "", "v_line/vc_QueueCtrl1__Pz3", "block", "57-58");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6236]), first, "../vc/queues.v", 70, 10, "", "v_toggle/vc_QueueCtrl1__Pz3", "do_enq", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6237]), first, "../vc/queues.v", 73, 10, "", "v_toggle/vc_QueueCtrl1__Pz3", "do_deq", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6238]), first, "../vc/queues.v", 79, 10, "", "v_toggle/vc_QueueCtrl1__Pz3", "empty", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6239]), first, "../vc/queues.v", 82, 10, "", "v_toggle/vc_QueueCtrl1__Pz3", "do_pipe", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[6240]), first, "../vc/queues.v", 85, 10, "", "v_toggle/vc_QueueCtrl1__Pz3", "do_bypass", "");
}
