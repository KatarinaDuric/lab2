...
VL_INLINE_OPT void Vtop_vc_Queue__Pz3_PB4d_PC1___act_comb__TOP__top__mem__mem__memreq1_queue__0(Vtop_vc_Queue__Pz3_PB4d_PC1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_vc_Queue__Pz3_PB4d_PC1___act_comb__TOP__top__mem__mem__memreq1_queue__0\n"); );
    // Body
